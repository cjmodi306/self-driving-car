...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        if self._start_control_loop:
            ...
            # D
            derivate = (e_v - self.vars.error_previous) / (st+1)
            ...
            print(waypoints[0][0],waypoints[0][1], waypoints[-1][0],waypoints[-1][1])
            # heading error
...
for idx in range(len(waypoints)):
    x.append(waypoints[idx][0])
    y.append(waypoints[idx][1])
    x_c.append(waypoints[idx][0]+np.random.randint(-10,10))
    y_c.append(waypoints[idx][1]+np.random.randint(-10,10))
    current_yaw

controller = Controller2D(waypoints)
controller.update_controls()

controller.show_path(x,y, 'g')
controller.show_path(x_c,y_c, 'r')
#plt.show()